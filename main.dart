...
//import 'package:codificacion_pae/app/themes/mytheme.dart';
...
import 'app/service/sizeservice.dart';

//v9 anda bien la v10esta rota
void main() async {
  WidgetsFlutterBinding.ensureInitialized();
  SharedPreferences prefs = await SharedPreferences.getInstance();
  int themeIndex = prefs.getInt(Themeservice.key) ?? 0;
  //double sizeIndex = prefs.getDouble(Sizeservice.key1) ?? 10;
  ...
  runApp(MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider/*<Sizeservice>*/(
          create: (_ /*context*/) => Sizeservice(),
        ),
        //ChangeNotifierProvider(create: (_) => Sizeservice()),
